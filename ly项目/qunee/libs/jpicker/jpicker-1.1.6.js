        ...
        function()
        {
          ...
          var isLessThanIE7 = parseFloat(navigator.appVersion.split('MSIE')[1]) < 7 && document.body.filters, // needed to run the AlphaImageLoader function for IE6
            ...
            setImg =
              function(img, src)
              {
                if (isLessThanIE7 && (src.indexOf(basePath+ '/ModelingAndSimulation/qunee/imgs/AlphaBar.png') != -1 || src.indexOf(basePath+ '/ModelingAndSimulation/qunee/imgs/Bars.png') != -1 || src.indexOf(basePath+ '/ModelingAndSimulation/qunee/imgs/Maps.png') != -1))
                {
                  img.attr('pngSrc', src);
              ...
              function(obj, alpha)
              {
                ...
                if (alpha > 0 && alpha < 100)
                {
                  if (isLessThanIE7)
                  {
                    ...
                    if (src != null && (src.indexOf(basePath+ '/ModelingAndSimulation/qunee/imgs/AlphaBar.png') != -1 || src.indexOf(basePath+ '/ModelingAndSimulation/qunee/imgs/Bars.png') != -1 || src.indexOf(basePath+ '/ModelingAndSimulation/qunee/imgs/Maps.png') != -1))
            ...
            initialize =
              function()
              {
                ...
                setTimeout(
                  function()
                  {
                    setImg.call($this, colorMapL1,  basePath+'/ModelingAndSimulation/qunee/imgs/Maps.png');
                    setImg.call($this, colorMapL2,  basePath+'/ModelingAndSimulation/qunee/imgs/Maps.png');
                    setImg.call($this, colorMapL3,  basePath+'/ModelingAndSimulation/qunee/imgs/map-opacity.png');
                    setImg.call($this, colorBarL1,  basePath+'/ModelingAndSimulation/qunee/imgs/Bars.png');
                    setImg.call($this, colorBarL2,  basePath+'/ModelingAndSimulation/qunee/imgs/Bars.png');
                    setImg.call($this, colorBarL3,  basePath+'/ModelingAndSimulation/qunee/imgs/Bars.png');
                    setImg.call($this, colorBarL4,  basePath+'/ModelingAndSimulation/qunee/imgs/Bars.png');
                    setImg.call($this, colorBarL5,  basePath+'/ModelingAndSimulation/qunee/imgs/bar-opacity.png');
                    setImg.call($this, colorBarL6,  basePath+'/ModelingAndSimulation/qunee/imgs/AlphaBar.png');
                    setImg.call($this, preview.find('div:first'), basePath+'/ModelingAndSimulation/qunee/imgs/preview-opacity.png');
                  }, 0);
                ...
                if (color.quickList && color.quickList.length > 0)
                {
                  ...
                  for (i = 0; i < color.quickList.length; i++)
                  {
                    ...
                    html+='<span class="QuickColor"' + (ahex && ' title="#' + ahex + '"' || '') + ' style="background-color:' + (quickHex && '#' + quickHex || '') + ';' + (quickHex ? '' : 'background-image:url(' + basePath+ '/ModelingAndSimulation/qunee/imgs/NoColor.png)') + (win.alphaSupport && alpha && alpha < 255 ? ';opacity:' + Math.precision(alpha / 255, 4) + ';filter:Alpha(opacity=' + Math.precision(alpha / 2.55, 4) + ')' : '') + '">&nbsp;</span>';
                  }
                  setImg.call($this, grid, basePath+ '/ModelingAndSimulation/qunee/imgs/bar-opacity.png');
                  grid.html(html);
                ...
                if (win.expandable)
                {
                  ...
                  setImg.call($this, iconAlpha, basePath+ '/ModelingAndSimulation/qunee/imgs/bar-opacity.png');
