...
(function (Q, $) {
    ...
    function createToolbar(graph, toolbar, customButtons) {
        ...
        function setInteractionMode(evt, info, interactionProperties) {
            ...
            // 解决框选操作问题
            if(info.value == Q.Consts.INTERACTION_MODE_SELECTION){
            	graph.onstart2 = function (evt){
...
//                    iconClass: 'toolbar-default'
//                },
//                {
//                    name: '框选模式',
//                    interactionMode: Q.Consts.INTERACTION_MODE_SELECTION,
//                    //iconClass: 'q-icon toolbar-rectangle_selection'
//                    iconClass: 'toolbar-rectangle_selection'
//                },
//                {
//                    name: '浏览模式',
//                    interactionMode: Q.Consts.INTERACTION_MODE_VIEW,
//                    //iconClass: 'q-icon toolbar-pan'
//                    iconClass: 'toolbar-pan'
//                }
//            ],
            zoom: [
                {
                    name: '放大', /*iconClass: 'q-icon toolbar-zoomin',*/ 
                    iconClass:' toolbar-zoomin',action: function () {
                    getGraph().zoomIn()
                }
                },
                {
                    name: '缩小', /*iconClass: 'q-icon toolbar-zoomout',*/ 
                    iconClass: 'toolbar-zoomout',action: function () {
                    getGraph().zoomOut()
                }
                },
                {
                    name: '1:1', /*iconClass: 'q-icon toolbar-zoomreset',*/ 
                    iconClass: 'toolbar-zoomreset',action: function () {
                    getGraph().scale = 1;
                }
                }/*,
                {
                    name: '纵览', iconClass: 'q-icon toolbar-overview', 
                    iconClass: 'toolbar-overview',action: function () {
...
//				    interactionMode: Q.Consts.INTERACTION_MODE_CREATE_SIMPLE_EDGE,
//				    //iconClass: 'q-icon toolbar-edge_VH',
//				    iconClass: 'icon-horizontal',
//				    edgeType: Q.Consts.EDGE_TYPE_HORIZONTAL_VERTICAL
//				},
//				/*{
//				    name: '创建虚线',
//				    interactionMode: Q.Consts.INTERACTION_MODE_CREATE_EDGE,
//				    iconClass: 'icon-dottedline',
//				    styles:{'edge.color':'#000000','edge.line.dash':[8,10]}
//				},*/{
//				    name: '创建垂直折线',
//				    interactionMode: Q.Consts.INTERACTION_MODE_CREATE_SIMPLE_EDGE,
//				    iconClass: 'icon-vertical',
//				    edgeType: Q.Consts.EDGE_TYPE_ORTHOGONAL_VERTICAL
//				    /*setStyle: Q.Styles.EDGE_CORNER, 
//				    setStyle: Q.Consts.EDGE_CORNER_NONE*/
//				}
//				/*{
//				    name: '创建多边形',
...
//            ],
            ...
            exportImage: {
                name: '导出图片', /*iconClass: 'q-icon toolbar-print',*/ 
                iconClass: 'toolbar-print',action: function () {
