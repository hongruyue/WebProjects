	...
	$.ajax({
		...
		success:function(result){
			...
			for(i in result){
				...
				console.log(result[i].system.systemName)
...
<body>
	<div id="man_zone" class="mianbody">
			...
			<form id="testForm" class="form-horizontal" method="post" enctype="multipart/form-data" action="<%=basePath%>CertificateTrail/insertRule.do">
				...
				<div class="col-md-12 col-xs-12 col-sm-12">
					...
					<div class="form-group">
							<div class="col-md-12 col-xs-12 col-sm-12" >
								...
								<div class="col-md-4 col-xs-4 col-sm-4">
								    <input type="text" class="input form-control"  id="ManagementRule" name="traceCredentialsStr" data-validation-engine="validate[required]" placeholder="请填写规则"/>
								</div>
							</div>
							<div class="col-md-12 col-xs-12 col-sm-12">
						    	...
						    	<a href="javascript:;" class="file">
							        <input type="file" name="file" title="选择文件" id="">选择文件
							    </a>
					...
					<div class="form-group">
						  	<div class="col-md-12 col-xs-12 col-sm-12" >
							    ...
							    <div class="col-md-4 col-xs-4 col-sm-4">
								    <input type="text" class="input form-control" id="SendingRule" name="traceSendRule" data-validation-engine="validate[required]" placeholder="请填写规则"/>
								</div>
						    </div>
					 </div>
					 <div class="form-group">
						  	<div class="col-md-12 col-xs-12 col-sm-12" >
							    ...
							    <div class="col-md-4 col-xs-4 col-sm-4">
								    <input type="text" class="input form-control" id="ReceiptRule" name="traceReceiveRule" data-validation-engine="validate[required]" placeholder="请填写规则"/>
							    </div>
							</div>
					 </div>
				</div>
